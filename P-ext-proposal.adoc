...
for i = 0 .. 3:
    ...
    if sshamt < 0:
        // Right shift
        do[(16*i+15):(16*i)] = shift_bits_right_arith(to_bits(16, a), -sshamt)
    else:
...
for i = 0 .. (XLEN/16 - 1):
    h = s1[(16*i+15):(16*i)]    // unsigned 16-bit
...
for i = 0 .. 1:
    dw = s[(64*i+63):(64*i)]
    if (dw <_s 0xFFFFFFFF80000000):
      d[(32*i+31):(32*i)] = 0x80000000; vxsat = 1;
    else if (dw >_s 0x000000007FFFFFFF):
      d[(32*i+31):(32*i)] = 0x7FFFFFFF; vxsat = 1;
    else:
       d[(32*i+31):(32*i)] = dw[31:0];
