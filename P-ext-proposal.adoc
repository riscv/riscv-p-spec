...
PPAIRE.B (Pack Pair Even Bytes) interleaves byte elements from `rs1` and `rs2`.
The even elements of the result come from the even elements of `rs1` and the odd
elements of the result come from the even elements of `rs2`.
...
PPAIRE.H (Pack Pair Even Halfwords) interleaves halfword elements from `rs1` and
`rs2`. The even elements of the result come from the even elements of `rs1` and
the odd elements of the result come from the even elements of `rs2`. On RV32,
this mnemonic is an alias for PACK.
...
PPAIRE.DB performs packed byte even-element pairing on double-wide
...
PPAIRE.DH performs packed halfword even-element pairing on double-wide
...
PPAIREO.B (Pack Pair Even-Odd Bytes) interleaves byte elements from `rs1` and
`rs2`. The even elements of the result come from the even elements of `rs1` and
the odd elements of the result come from the odd elements of `rs2`.
...
PPAIREO.H (Pack Pair Even-Odd Halfwords) interleaves halfword elements from
`rs1` and `rs2`. The even elements of the result come from the even elements of
`rs1` and the odd elements of the result come from the odd elements of `rs2`.
...
PPAIREO.W (Pack Pair Even-Odd Words) interleaves word elements from `rs1` and
`rs2`. The even element of the result comes from the even element of `rs1` and
the odd element of the result comes from the odd element of `rs2`.
...
PPAIREO.DB performs packed byte even-odd element pairing on double-wide
...
PPAIREO.DH performs packed halfword even-odd element pairing on double-wide
...
PPAIROE.B (Pack Pair Odd-Even Bytes) interleaves byte elements from `rs1` and
`rs2`. The even elements of the result come from the odd elements of `rs1` and
the odd elements of the result come from the even elements of `rs2`.
...
PPAIROE.H (Pack Pair Odd-Even Halfwords) interleaves halfword elements from
`rs1` and `rs2`. The even elements of the result come from the odd elements of
`rs1` and the odd elements of the result come from the even elements of `rs2`.
...
PPAIROE.W (Pack Pair Odd-Even Words) interleaves word elements from `rs1` and
`rs2`. The even element of the result comes from the odd element of
`rs1` and the odd element of the result comes from the even elements of `rs2`.
...
PPAIROE.DB performs packed byte odd-even element pairing on double-wide
...
PPAIROE.DH performs packed halfword odd-even element pairing on double-wide
...
PPAIRO.B (Pack Pair Odd Bytes) interleaves byte elements from `rs1` and `rs2`.
The even elements of the result come from the odd elements of `rs1` and
the odd elements of the result come from the odd elements of `rs2`.
...
PPAIRO.H (Pack Pair Odd Halfwords) interleaves halfword elements from `rs1` and
`rs2`. The even elements of the result come from the odd elements of `rs1` and
the odd elements of the result come from the odd elements of `rs2`.
...
PPAIRO.W (Pack Pair Odd Words) interleaves word elements from `rs1` and `rs2`.
The even element of the result comes from the odd element of `rs1` and
the odd element of the result comes from the odd element of `rs2`.
...
PPAIRO.DB performs packed byte odd-element pairing on double-wide
...
PPAIRO.DH performs packed halfword odd-element pairing on double-wide
